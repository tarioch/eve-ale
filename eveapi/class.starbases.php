<?php
/**************************************************************************
	Ale API Library for EvE StarbaseList/StarbaseDetail Class legacy include file
...
require_once(dirname(__FILE__).'/class.starbaselist.php'); 
require_once(dirname(__FILE__).'/class.starbasedetail.php'); 
?>